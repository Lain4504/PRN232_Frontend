...
export function AuthSplitLayout({
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-slate-900 overflow-hidden relative selection:bg-rose-100 selection:text-rose-600">
      {/* Background Decorations */}
      <div className="absolute inset-0 z-0 pointer-events-none opacity-40">
        <div className="absolute top-0 right-0 w-[50%] h-[50%] bg-rose-200/30 blur-[120px]" />
        <div className="absolute bottom-0 left-0 w-[40%] h-[40%] bg-blue-100/30 blur-[100px]" />
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-12 min-h-screen relative z-10">
        {/* Left: Auth Area */}
        <div className="lg:col-span-5 flex items-center justify-center p-8 sm:p-12 xl:p-24 bg-white/40 backdrop-blur-2xl border-r border-white/20">
          <div className="w-full max-w-md space-y-10 animate-in fade-in slide-in-from-left-4 duration-700">
            ...
            <Link href="/" className="flex items-center gap-2 w-fit group">
              ...
              <span className="text-2xl font-bold tracking-tight text-slate-900 font-sans">omniadly</span>
            </Link>

            <div className="space-y-4">
              <h1 className="text-4xl font-black tracking-tight text-slate-900 leading-tight">{title}</h1>
            ...
            <div className="flex items-center justify-between pt-8 border-t border-slate-100">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Kết nối bảo mật</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-1.5 w-1.5 rounded-full bg-green-500 animate-pulse" />
                <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Hệ thống đang hoạt động</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="hidden lg:col-span-7 lg:flex flex-col justify-center p-24 bg-slate-50/50 relative overflow-hidden">
          <div className="relative z-10 max-w-2xl space-y-16 animate-in fade-in slide-in-from-right-8 duration-1000">
            {/* Benefits Card */}
            <div className="bg-white p-12 rounded-[2.5rem] shadow-2xl shadow-slate-200/50 relative overflow-hidden border border-slate-100">
              ...
              {[
                ...
                <div key={stat.label} className="space-y-3">
                  <div className="flex items-center gap-2 opacity-40">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-900">{stat.label}</span>
                  </div>
                  <div className="text-5xl font-black tracking-tighter text-slate-900">{stat.value}</div>
                </div>
              ))}
            </div>

            <div className="flex items-center gap-6 px-6 opacity-30 invert grayscale">
              <CheckCircle2 className="size-6" />
              <span className="font-bold tracking-tighter text-xl">TRUSTED PARTNER</span>
            </div>
          </div>
