...
export function HomeContent() {
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-slate-950 text-slate-900 dark:text-slate-50 selection:bg-rose-100 selection:text-rose-600 dark:selection:bg-primary/20 dark:selection:text-primary">
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 overflow-hidden">
        {/* Abstract Background Decoration */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[800px] -z-10 opacity-40 dark:opacity-20">
          <div className="absolute top-[-10%] right-[-10%] w-[600px] h-[600px] bg-rose-200 dark:bg-rose-900/40 rounded-full blur-[120px]" />
          <div className="absolute top-[20%] left-[-10%] w-[500px] h-[500px] bg-blue-100 dark:bg-blue-900/40 rounded-full blur-[100px]" />
        </div>

        <div className="max-w-7xl mx-auto px-6 text-center space-y-10">
          <div className="space-y-6 max-w-4xl mx-auto">
            <div className="flex justify-center animate-in fade-in slide-in-from-bottom-4 duration-700">
              <Badge variant="outline" className="px-4 py-1.5 rounded-full border-rose-200 dark:border-rose-900/50 bg-rose-50/50 dark:bg-rose-950/50 text-rose-600 dark:text-rose-400 font-bold text-xs backdrop-blur-sm">
                <Sparkles className="size-3.5 mr-2 fill-rose-600 dark:fill-rose-400" />
                Nền tảng quảng cáo AI thế hệ mới
              </Badge>
            </div>

            <h1 className="text-5xl sm:text-6xl md:text-8xl font-black tracking-tight text-slate-900 dark:text-white leading-[1.05] animate-in fade-in slide-in-from-bottom-6 duration-1000">
              Tự động hóa <br />
              <span className="bg-gradient-to-r from-rose-600 to-blue-600 bg-clip-text text-transparent">Quảng cáo đa kênh</span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
            <Button asChild size="lg" className="h-14 px-10 rounded-2xl font-bold bg-primary hover:bg-primary/90 text-white shadow-2xl shadow-primary/20 transition-all hover:-translate-y-1">
              <Link href="/auth/sign-up" className="flex items-center gap-2">
                Bắt đầu miễn phí
                <ArrowRight className="size-5" />
              </Link>
            </Button>
            <Button asChild variant="ghost" size="lg" className="h-14 px-10 rounded-2xl font-bold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100/50 dark:hover:bg-slate-800/50 transition-all">
          ...
          <div className="relative mt-20 max-w-6xl mx-auto animate-in fade-in zoom-in duration-1000 delay-500">
            ...
            <div className="relative rounded-2xl border border-white dark:border-slate-800 bg-white/40 dark:bg-slate-900/40 backdrop-blur-3xl p-1.5 shadow-[0_32px_80px_-20px_rgba(0,0,0,0.08)] dark:shadow-black/20 overflow-hidden">
            ...
            <div className="mt-16 flex flex-col items-center gap-8 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-700">
              <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 dark:text-slate-600">Tích hợp đa nền tảng</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-5 group">
                    <div className="size-12 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 flex items-center justify-center text-slate-400 group-hover:text-primary group-hover:bg-primary/5 transition-colors">
            ...
            <div className="relative">
              <div className="relative rounded-3xl overflow-hidden border border-slate-100 dark:border-slate-800 shadow-2xl">
                <Image
      ...
      {/* Core Features Grid */}
      <section className="py-32 px-6 bg-[#FAFAFA] dark:bg-slate-900/50">
        <div className="max-w-7xl mx-auto space-y-20">
          <div className="text-center space-y-4 max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tight">Tính năng cốt lõi</h2>
            <p className="text-slate-500 dark:text-slate-400 font-medium font-lg">Mọi công cụ bạn cần để chinh phục khách hàng trên mạng xã hội.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card key={i} className="group p-8 rounded-3xl border-white/50 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl hover:shadow-2xl hover:shadow-slate-200/50 dark:hover:shadow-black/50 transition-all hover:-translate-y-2 cursor-pointer relative overflow-hidden">
                ...
                <div className="size-14 rounded-2xl bg-white dark:bg-slate-800 shadow-lg shadow-slate-200 dark:shadow-black/20 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  <feature.icon className="size-7 text-slate-900 dark:text-white" />
                </div>
      ...
      <section className="py-32 px-6 bg-white dark:bg-slate-950 overflow-hidden relative">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="order-2 lg:order-1 relative">
              <div className="grid grid-cols-2 gap-6 relative z-10">
                {[
                  ...
                  <div key={i} className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border border-slate-100 dark:border-slate-800 p-8 rounded-2xl shadow-xl hover:shadow-2xl dark:hover:shadow-black/50 transition-all hover:-translate-y-1">
                    ...
                    <div className={cn("text-xs font-bold", stat.trend.startsWith('+') ? "text-green-500" : "text-red-500")}>
                      {stat.trend} <span className="text-slate-300 dark:text-slate-600 font-medium">so với tháng trước</span>
                    </div>
                  </div>
                ))}
              </div>
              {/* Background Glass Plate */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-slate-50 dark:bg-slate-900 rounded-full blur-[100px] -z-10 opacity-50 dark:opacity-20" />
            </div>
      ...
      <section className="py-32 px-6 bg-[#FAFAFA] dark:bg-slate-900/50">
        <div className="max-w-7xl mx-auto space-y-20">
          <div className="text-center space-y-4 max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tight">Bảng giá linh hoạt</h2>
            <p className="text-slate-500 dark:text-slate-400 font-medium font-lg">Chọn gói dịch vụ phù hợp để bắt đầu hành trình tăng trưởng cùng AI.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div key={i} className={cn(
                "p-10 rounded-3xl border bg-white dark:bg-slate-900 relative transition-all hover:-translate-y-2 duration-300",
                plan.popular ? "border-primary shadow-2xl shadow-primary/10" : "border-slate-100 dark:border-slate-800"
              )}>
                {plan.popular && (
                ...
                <div className="mb-8">
                  <div className="text-sm font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2">{plan.name}</div>
                  <div className="flex items-baseline gap-1">
                    <span className="text-4xl font-black text-slate-900 dark:text-white">{plan.price}</span>
                    <span className="text-slate-400 dark:text-slate-500 font-medium">đ/tháng</span>
                  </div>
                </div>
                ...
                <Button variant={plan.popular ? "default" : "outline"} className={cn(
                  ...
                  plan.popular ? "bg-primary text-white hover:bg-primary/90 shadow-lg shadow-primary/20" : "border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800"
                )}>
                  {plan.cta}
                </Button>
              </div>
      ...
      <section className="py-32 px-6 bg-white dark:bg-slate-950">
        <div className="max-w-7xl mx-auto rounded-[3.5rem] bg-slate-900 dark:bg-slate-900/80 text-white p-16 md:p-24 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 space-y-10 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button asChild variant="ghost" size="lg" className="h-16 px-12 rounded-2xl font-bold text-white hover:bg-white/10">
      ...
      {/* Footer */}
      <footer className="py-24 px-6 border-t border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-950">
        <div className="max-w-7xl mx-auto">
          <div className="grid gap-16 lg:grid-cols-4 pb-20">
            ...
            {[
              ...
              <div key={i}>
                <h4 className="font-bold text-xs uppercase tracking-widest text-slate-400 dark:text-slate-600 mb-8">{col.title}</h4>
                <ul className="space-y-4">
                  {col.links.map((link, j) => (
                    <li key={j}>
                      <Link href="#" className="text-sm font-bold text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-primary transition-colors">{link}</Link>
                    </li>
                  ))}
                </ul>
              </div>
