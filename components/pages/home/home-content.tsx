      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Quản lý chiến dịch quảng cáo đa nền tảng (TikTok, Facebook, Instagram) trong một nơi duy nhất. Tự động hoá
            tạo nội dung, quản lý tài sản thương hiệu, đăng lịch và phân tích hiệu quả bằng AI.
          </p>
        </div>
        ...
        <div className="mt-12 flex items-center justify-center gap-4">
          ...
          <Button asChild variant="outline">
            <Link href="/organizations">Xem tổ chức</Link>
          </Button>
        </div>
      </div>
    </div>
