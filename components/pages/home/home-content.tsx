...
export function HomeContent() {
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-slate-900 selection:bg-rose-100 selection:text-rose-600">
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 overflow-hidden">
        {/* Abstract Background Decoration */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[800px] -z-10 opacity-40">
          <div className="absolute top-[-10%] right-[-10%] w-[600px] h-[600px] bg-rose-200 rounded-full blur-[120px]" />
          <div className="absolute top-[20%] left-[-10%] w-[500px] h-[500px] bg-blue-100 rounded-full blur-[100px]" />
        </div>

        <div className="max-w-7xl mx-auto px-6 text-center space-y-10">
          <div className="space-y-6 max-w-4xl mx-auto">
            <div className="flex justify-center animate-in fade-in slide-in-from-bottom-4 duration-700">
              <Badge variant="outline" className="px-4 py-1.5 rounded-full border-rose-200 bg-rose-50/50 text-rose-600 font-bold text-xs backdrop-blur-sm">
                <Sparkles className="size-3.5 mr-2 fill-rose-600" />
                Nền tảng quảng cáo AI thế hệ mới
              </Badge>
            </div>

            <h1 className="text-5xl sm:text-6xl md:text-8xl font-black tracking-tight text-slate-900 leading-[1.05] animate-in fade-in slide-in-from-bottom-6 duration-1000">
              Tự động hóa <br />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
            ...
            <Button asChild variant="ghost" size="lg" className="h-14 px-10 rounded-2xl font-bold text-slate-600 hover:text-slate-900 hover:bg-slate-100/50 transition-all">
          ...
          <div className="relative mt-20 max-w-6xl mx-auto animate-in fade-in zoom-in duration-1000 delay-500">
            ...
            <div className="relative rounded-[2rem] border border-white bg-white/40 backdrop-blur-3xl p-1.5 shadow-[0_32px_80px_-20px_rgba(0,0,0,0.08)] overflow-hidden">
              <div className="relative rounded-[1.5rem] overflow-hidden border border-slate-100/50 bg-slate-50/20 aspect-[21/9]">
                <Image
            ...
            <div className="mt-16 flex flex-col items-center gap-8 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-700">
              <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Tích hợp đa nền tảng</p>
              <div className="flex flex-wrap items-center justify-center gap-12 md:gap-20 opacity-30 grayscale hover:opacity-80 hover:grayscale-0 transition-all duration-500">
                <div className="flex items-center gap-3">
                  <svg className="size-6 fill-slate-900" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1.04-.1z" /></svg>
                  <span className="text-xl font-black tracking-tighter text-slate-900">TikTok</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="size-6 fill-slate-900" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                  <span className="text-xl font-black tracking-tighter text-slate-900">Facebook</span>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xl font-black tracking-tighter text-slate-900">Instagram</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-5 group">
                    <div className="size-12 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-400 group-hover:text-primary group-hover:bg-primary/5 transition-colors">
      ...
      <section className="py-32 px-6 bg-[#FAFAFA]">
        <div className="max-w-7xl mx-auto space-y-20">
          <div className="text-center space-y-4 max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tight">Tính năng cốt lõi</h2>
            <p className="text-slate-500 font-medium font-lg">Mọi công cụ bạn cần để chinh phục khách hàng trên mạng xã hội.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card key={i} className="group p-8 rounded-[2.5rem] border-white/50 bg-white/50 backdrop-blur-xl hover:shadow-2xl hover:shadow-slate-200/50 transition-all hover:-translate-y-2 cursor-pointer relative overflow-hidden">
                ...
                <div className="size-14 rounded-2xl bg-white shadow-lg shadow-slate-200 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  <feature.icon className="size-7 text-slate-900" />
                </div>
            ...
            <div className="order-2 lg:order-1 relative">
              <div className="grid grid-cols-2 gap-6 relative z-10">
                {[
                  ...
                  <div key={i} className="bg-white/80 backdrop-blur-md border border-slate-100 p-8 rounded-[2rem] shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1">
                    ...
                    <div className={cn("text-xs font-bold", stat.trend.startsWith('+') ? "text-green-500" : "text-red-500")}>
                      {stat.trend} <span className="text-slate-300 font-medium">so với tháng trước</span>
                    </div>
                  </div>
                ))}
              </div>
              {/* Background Glass Plate */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-slate-50 rounded-full blur-[100px] -z-10 opacity-50" />
            </div>

            <div className="order-1 lg:order-2 space-y-8">
              <Badge variant="outline" className="px-4 py-1.5 rounded-full border-blue-100 bg-blue-50 text-blue-600 font-bold text-xs">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-center gap-3 text-slate-700 font-bold">
                    <div className="size-6 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 italic">
      ...
      <section className="py-32 px-6 bg-[#FAFAFA]">
        <div className="max-w-7xl mx-auto space-y-20">
          <div className="text-center space-y-4 max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tight">Bảng giá linh hoạt</h2>
            <p className="text-slate-500 font-medium font-lg">Chọn gói dịch vụ phù hợp để bắt đầu hành trình tăng trưởng cùng AI.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div key={i} className={cn(
                "p-10 rounded-[2.5rem] border bg-white relative transition-all hover:-translate-y-2 duration-300",
                plan.popular ? "border-primary shadow-2xl shadow-primary/10" : "border-slate-100"
              )}>
                {plan.popular && (
                ...
                <div className="mb-8">
                  ...
                  <div className="flex items-baseline gap-1">
                    ...
                    <span className="text-slate-400 font-medium">đ/tháng</span>
                  </div>
                </div>
                ...
                <Button variant={plan.popular ? "default" : "outline"} className={cn(
                  ...
                  plan.popular ? "bg-primary text-white hover:bg-primary/90" : "border-slate-200 text-slate-600 hover:bg-slate-50"
                )}>
                  {plan.cta}
                </Button>
              </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto rounded-[3.5rem] bg-slate-900 text-white p-16 md:p-24 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="grid gap-16 lg:grid-cols-4 pb-20">
            <div className="space-y-6">
              <Link href="/" className="flex items-center gap-3">
                ...
                <span className="text-2xl font-bold text-slate-900 tracking-tight">omniadly</span>
              </Link>
            ...
            {[
              ...
              <div key={i}>
                <h4 className="font-bold text-xs uppercase tracking-widest text-slate-400 mb-8">{col.title}</h4>
                <ul className="space-y-4">
                  {col.links.map((link, j) => (
                    <li key={j}>
                      <Link href="#" className="text-sm font-bold text-slate-600 hover:text-primary transition-colors">{link}</Link>
                    </li>
                  ))}
                </ul>
              </div>
