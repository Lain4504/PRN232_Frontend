...
import { User as UserType, Profile, Brand, CreateBrandForm as BrandFormType } from "@/lib/types/aisam-types";
...
export function EditBrandForm({ brandId }: EditBrandFormProps) {
    ...
    const [formData, setFormData] = useState<BrandFormType>({
        name: '',
        description: '',
        slogan: '',
        usp: '',
            ...
            try {
                ...
                if (brandResponse.success && brandResponse.data) {
                    ...
                    setFormData({
                        ...
                        profile_id: brandData.profile_id || undefined,
                    });
                    ...
                    // Set link to profile checkbox
                    setLinkToProfile(!!brandData.profile_id);
                } else {
    ...
    const handleInputChange = (field: keyof BrandFormType, value: string | undefined) => {
        setFormData(prev => ({
            ...prev,
            [field]: value
        }));
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Update your brand&apos;s voice and visual identity
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            {/* Logo Upload */}
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Update your unique value proposition and target audience
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            <div className="space-y-2">
                ...
                <Card className="mt-6">
                    <CardContent className="pt-6">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="font-medium mb-1">Keep your brand updated</h3>
                                <p className="text-sm text-muted-foreground">
                                    Regular updates to your brand information help AISAM generate more relevant and consistent content.
                                    Make sure your brand details reflect your current business strategy and target audience.
                                </p>
                            </div>
                        </div>
                    </CardContent>
