...
export default function NewOrganizationPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col">
            {/* Header */}
            <OrganizationHeader currentPage="New organization" />

            <div className="flex-1 p-4 sm:p-6 lg:p-8">
                <div className="max-w-2xl mx-auto">
                    <Card className="border border-gray-200 shadow-sm">
                        <CardHeader className="px-4 sm:px-6 pt-6 pb-4">
                            <CardTitle className="text-lg sm:text-xl font-medium text-gray-900">Create a new organization</CardTitle>
                            <CardDescription className="text-sm sm:text-base text-gray-600 mt-2">
                                This is your organization within AISAM.
