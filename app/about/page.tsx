...
export const metadata: Metadata = {
    title: "AISAM | Our Mission",
    description: "AISAM is the leading AI platform for modern marketing teams.",
};
                ...
                <div className="max-w-[1440px] mx-auto space-y-32">
                    ...
                    <section className="text-center space-y-8 max-w-4xl mx-auto">
                        ...
                        <h1 className="text-6xl md:text-8xl font-black tracking-tight uppercase leading-[0.9]">
                            The Modern AI <br />
                            <span className="text-primary italic">Marketing</span> Hub.
                        </h1>
                        <p className="text-xl md:text-2xl text-muted-foreground font-medium leading-relaxed">
                            We build the infrastructure for the next generation of social advertisers.
                            AISAM is designed to simplify creative work and unify global brand management.
                        </p>
                    </section>
                    ...
                    <section className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                        {[
                            { icon: Shield, title: "Control", desc: "Maintain absolute control over your brand identity and digital assets.", color: "text-blue-500" },
                            { icon: Target, title: "Precision", desc: "Surgical accuracy in content generation and deployment timing.", color: "text-rose-500" },
                            { icon: Rocket, title: "Speed", desc: "Faster creative cycles to stay ahead of market trends and competitors.", color: "text-amber-500" },
                            { icon: Users, title: "Collaboration", desc: "Seamless orchestration across multiple brands and global teams.", color: "text-emerald-500" },
                            { icon: Globe, title: "Global Reach", desc: "Instant deployment across all major social media platforms.", color: "text-indigo-500" },
                            { icon: Zap, title: "Automation", desc: "Self-optimizing AI engines that learn from performance data.", color: "text-orange-500" },
                        ].map((value) => (
                            <div key={value.title} className="p-12 rounded-[3rem] bg-card/40 border border-border/40 backdrop-blur-3xl hover:bg-card/60 transition-all group">
                    ...
                    <section className="relative py-32 px-10 rounded-[4rem] bg-primary overflow-hidden group">
                        ...
                        <div className="relative z-10 text-center space-y-12">
                            <h2 className="text-5xl md:text-7xl font-black text-white leading-none uppercase tracking-tighter">
                                ...
                                <span className="text-white/40 italic">Social</span> Presence?
                            </h2>
