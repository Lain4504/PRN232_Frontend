                ...
                <div className="max-w-[1440px] mx-auto space-y-32">
                    ...
                    <section className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                        {[
                            ...
                            <div key={mod.title} className="p-12 rounded-[3rem] bg-card/40 border border-border/40 backdrop-blur-3xl hover:bg-card/60 transition-all group">
                    ...
                    <section className="relative py-32 px-10 rounded-[5rem] bg-emerald-600 overflow-hidden group text-center space-y-12 shadow-2xl shadow-emerald-500/20">
                        <div className="absolute inset-0 bg-gradient-to-br from-emerald-600 via-teal-700 to-emerald-900 opacity-90" />
                        <div className="space-y-6 relative z-10">
                            <h2 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter leading-none">Unlock the <br /><span className="text-white/40 italic">Insights</span></h2>
                        </div>
                        <div className="flex justify-center gap-6 relative z-10">
                            <Button asChild size="lg" className="h-20 px-16 bg-white text-emerald-600 font-black uppercase tracking-[0.2em] rounded-[2.5rem] shadow-2xl hover:scale-110 transition-all text-sm">
